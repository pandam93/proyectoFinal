    ...
    <ul class="list-group">        
         ...
         <li class="list-group-item">
             <h2 class="blog-post-title">
                 <li class="list-group-item"><a href="/proyectoFinal/public/articles/{{ $article->id }}">{{ $article->title }}</a>                              
             </h2>
         </li>                 
         @endforeach
    </ul>
        ...
        <aside class="col-md-4 blog-sidebar">
            <div class="p-3">
                <h3 class="blog-post-title">This week we showcase the articles
                    Written by <p></p>
                    <a href="/proyectoFinal/public/users/{{ $article->user_id }}/articles">{{ $article->user->name }}</a>
          </h3>
                <strong>Showing the first four results</strong><p></p>
                <italic>His first article is:</italic>
                <p></p>
                <a href="/proyectoFinal/public/articles/{{ $article->user->article->id }}">
